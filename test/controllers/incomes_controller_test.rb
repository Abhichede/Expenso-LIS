...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { amount: @income.amount, from: @income.from, received_by: @income.received_by } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { amount: @income.amount, from: @income.from, received_by: @income.received_by } }
